...
import type {MpsVersionKpi} from '../types';
...
function KpiIcon({icon, tone}: {icon: MpsVersionKpi['icon']; tone: MpsVersionKpi['tone']}) {
...
interface MpsVersionKpiCardsProps {
  cards: MpsVersionKpi[];
}

export default function MpsVersionKpiCards({cards}: MpsVersionKpiCardsProps) {
  return (
